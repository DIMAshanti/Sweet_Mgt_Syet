...
import io.cucumber.java.en.When;
    ...
    public class MonitoringandReporting {
        ...
        public void i_am_logged_into_the_system_as_a(String string) {
        ...
        public void i_select_the_store(String string) {

        }

        @When("I select the date range {string} to {string}")
        public void i_select_the_date_range_to(String string, String string2) {

        }

        @Then("I should see the financial report for {string} for the selected date range")
        public void i_should_see_the_financial_report_for_for_the_selected_date_range(String string) {
        ...
        public void i_should_see_the_current_profit_for(String string) {
        ...
        public void i_should_see_a_list_of_the_best_selling_products_for(String string) {
        ...
        public void i_should_see_statistics_for_registered_users_in(String string) {
        ...
        public void i_select_the_city_ramallah() {
        }

        @Then("I should see statistics for registered users in \"Ramallah")
        public void i_should_see_statistics_for_registered_users_in_ramallah() {
